...
\begin{flushleft}
  ...
  \begin{large}
    \begin{enumerate}
      ...
      \item \textbf{Chandan C Raikar}         \hspace{3.39cm}USN:01FE21BEC038
      \item \textbf{Divya R Salmani}          \hspace{3.85cm}USN:01FE21BEC013
      \item \textbf{Sanjana Adagimath }       \hspace{3.05cm}USN:01FE21BEC363
    \end{enumerate}
    \vspace{1cm}
  \end{large}
  \begin{Large}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{Yolov8_Arch.png}%\href{https://blog.roboflow.com/whats-new-in-yolov8/}{[1]}
